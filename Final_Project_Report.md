...
The scripts have been solely produced, tested and executed on Windows 7 and RStudio Version 0.99.896.  
Developer: <b>Nirmal Roy</b>  
GitHub Repo: [<https://github.com/UtkarshPathrabe/Practical-Machine-Learning-Johns-Hopkins-Bloomberg-School-of-Public-Health-Coursera/tree/master/Project>](https://github.com/NirmalRoy/PracticalMachineLearningProjectReport)  
Rpub: [<https://github.com/NirmalRoy/PracticalMachineLearningProjectReport>](https://github.com/NirmalRoy/PracticalMachineLearningProjectReport)  
...
``` r
trainRaw <- read.csv("C:/Users/abc/Downloads/pml-training.csv")
testRaw <- read.csv("C:/Users/abc/Downloads/pml-testing.csv")
dim(trainRaw)
```
...
![](D:/F/Books/Videos/Coursera/Data Science Specialization/unnamed-chunk-11-1.png)
...
```
    ...
    ## 
    ##   mtry  Accuracy   Kappa    
    ##      2    0.9935210  0.9918047
    ##     27    0.9970151  0.9962243
    ##     53    0.9953406  0.9941056
    ## 
...
```
    ...
    ## 
                    Class: A Class: B Class: C Class: D Class: E
                    Sensitivity            0.9976   0.9991   0.9961   0.9958   0.9991
                    Specificity            1.0000   0.9992   0.9992   0.9990   0.9998
                    Pos Pred Value         1.0000   0.9965   0.9961   0.9948   0.9991
                    Neg Pred Value         0.9991   0.9998   0.9992   0.9992   0.9998
                    Prevalence             0.2851   0.1930   0.1743   0.1636   0.1839
                    Detection Rate         0.2845   0.1929   0.1737   0.1630   0.1837
                    Detection Prevalence   0.2845   0.1935   0.1743   0.1638   0.1839
                    Balanced Accuracy      0.9988   0.9991   0.9976   0.9974   0.9994
...
pml_write_files = function(x){
  n = length(x)
  for(i in 1:n){
    filename = paste0("D:/F/Books/Videos/Coursera/Data Science Specialization/Assignment Solution/problem_id_",i,".txt")
